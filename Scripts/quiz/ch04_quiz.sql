...
-- 정답:
SELECT quantity * price '총 매출액' FROM orders;
SELECT SUM(quantity * price) '총 매출액' FROM orders;
...
-- 정답:
SELECT SUM(quantity * price) '총 매출액' 
FROM orders 
...
-- 정답:
SELECT COUNT(DISTINCT region) '지역 종류 개수' FROM orders;
