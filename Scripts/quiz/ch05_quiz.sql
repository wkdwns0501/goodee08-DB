...
-- 정답: VARCHAR는 가변길이(데이터 크기만큼 차지)이고 CHAR는 고정길이(지정한 크기만큼 차지)
...
-- 정답: 제한된 값 목록만 저장하도록 강제할 수 있기 때문
...
-- 정답: FLOAT는 약 7자리 정확도, DOUBLE은 약 15자리 정확도
...
-- 정답: 1000-01-01부터 9999-12-31 / 날짜 (YYYY-MM-DD)
...
-- 정답: customer_name이 박으로 시작하는 2글자
...
-- 정답:
SELECT title, event_date FROM events WHERE event_date BETWEEN '2023-10-01' AND '2023-12-31';
...
-- 문제 8
-- 이벤트 날짜가 2023-11-01부터 2023-12-31 사이고, 
