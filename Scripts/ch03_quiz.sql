...
-- 정답:
SELECT name, price FROM products WHERE price >= 300000;

-- 문제 2
-- 카테고리가 '전자기기'이고 재고가 10개 이상인 제품명과 재고를 조회하세요.

-- 정답:
SELECT name, stock FROM products WHERE category = '전자기기' AND stock >= 10;

-- 문제 3
-- 가격에 10% 세금을 적용한 최종 가격을 계산해 제품명과 함께 조회하세요.

-- 정답:
SELECT name, price * 1.1 total_price FROM products;

-- 문제 4
-- 카테고리가 '전자기기'가 아닌 제품을 찾아 제품명과 카테고리를 조회하세요.

-- 정답:
SELECT name, category FROM products WHERE category != '전자기기';

-- 문제 5
-- 재고가 10개 이하인 제품 중 가격을 20% 할인해 제품명과 가격을 조회하세요.

-- 정답:
SELECT name, price * 0.8 sale_price FROM products WHERE stock <= 10;
...
-- 정답:
SELECT name, stock, price * 0.7 sale_price 
FROM products 
...
-- 정답:
SELECT name, price * stock total_sales FROM products;
